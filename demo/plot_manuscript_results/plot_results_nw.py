...
parser.add_argument("--measure", type=str, default ='corr')

args = parser.parse_args()

name_score = args.score # 'g', 'gc', 'gf' 
name_sample = args.sample # 'main', 'lockbox', 'repli'
name_measure = args.measure # 'corr', 'MSE', 'RMSE', 'MAE'
