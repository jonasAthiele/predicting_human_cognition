...
### Apply models build in HCP sample to
### predict intelligence scores in the replication sample (PIOP1 and PIOP2 combined)
### for models that were trained with links (edges, connections) between specific nodes (from intelligence theories),
### models trained with links between randomly chosen nodes,
...
path_models = 'res_30nodes_connection_rand' #Folder of saved models
...
name_save = 'corr_g_repli_' + name_nodes
